...
const REQUIRED_AGENT_DATABASE_INDEXES = [
  ...
  'agent_messages_run_assistant_final_idx',
  'agent_messages_run_assistant_streaming_idx',
  'agent_messages_run_assistant_turn_idx',
...
const REQUIRED_AGENT_DATABASE_TRIGGERS = [
  ...
  'agent_messages_validate_assistant_insert',
  'agent_messages_validate_assistant_update',
  ...
  'agent_runs_update_session_terminal',
  'agent_runs_validate_assistant_terminal',
