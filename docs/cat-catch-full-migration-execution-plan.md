...
- HLS 纯 port 已补上媒体分片继承紧邻前序 BYTERANGE end、MAP 独立 range、AES-128 sequence-derived IV、初始 discontinuity sequence、空/无效媒体清单拒绝和 PNG/JPEG 伪装分片剔除等首批语义并有 fixture；完整 parser 差分和最终 pipeline cutover 仍待完成。
