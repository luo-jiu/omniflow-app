...
截至 2026-08-29，capability map 的最新统计为 226 个 active 测试引用、229 个计划测试 ID、102 个 cleanup entry；普通直链、已捕获资源、HLS/MPD 直拉和 HLS 计划下载已接入 staged output lease，但不改变其他 output 能力仍在迁移中的结论。
