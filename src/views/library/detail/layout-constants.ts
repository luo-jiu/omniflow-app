...
export const TOOLBAR_ACTION_ICON_SIZE = 13;
...
export const SIDE_PANEL_TOGGLE_LEFT = 86;
...
export const CONTENT_TOOLBAR_COLLAPSED_SAFE_SPACE = SIDE_PANEL_TOGGLE_LEFT + SIDE_PANEL_TOGGLE_SIZE - 4;
