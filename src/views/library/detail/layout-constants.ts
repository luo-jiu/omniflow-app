...
export const WINDOWS_SIDE_PANEL_TOGGLE_VISUAL_LEFT = 10;
...
export const WINDOWS_CONTENT_TOOLBAR_COLLAPSED_SAFE_SPACE = WINDOWS_SIDE_PANEL_TOGGLE_VISUAL_LEFT + SIDE_PANEL_TOGGLE_SIZE + 4;
